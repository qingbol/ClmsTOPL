...
// class IfNode : public Node{
// public:
//    IfNode(const Node* n, const Node* ifstmt, const Node* elifstmt, const Node* elsestmt):
//      test(n),ifSuite(ifstmt), elifSuite(elifstmt), elseSuite(elsestmt) {
//    }
//    IfNode(const IfNode&) = delete;
//    const IfNode* operator=(const IfNode& i) = delete;
//    ~IfNode() {}
...
//    const Node* test;
//    const Node* ifSuite;
//    const Node* elifSuite;
//    const Node* elseSuite;
// };

// class ElifNode : public Node{
// public:
//    ElifNode(const Node* n, const Node* elifstmt):
//      test(n), elifSuite(elifstmt) {
//    }
